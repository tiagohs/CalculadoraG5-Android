...
{
	private final String[] OPERADORES = {"+", "-", "*", "/", "^", "~", "%", "sin", "cos", "tan", "asin", "acos", "atan", "coss", "sec", "cot", "log", "ln", "exp", "sqrt", "(", ")"};
	private final String[] NOME_OPERADORES = {"add", "sub", "multiply", "div", "pow", "neg", "mod", "sin", "cos", "tan", "asin", "acos", "atan", "coss", "sec", "cot", "log", "ln", "exp", "sqrt"};
	
	private final int[] PRECEDENCIA = {1,1,2,2,3,4,2,4,4,4,4,4,4,4,4,4,4,4,4,4,-1,-1};
	...
	/**
	 * O Construtor ir� ler a equa��o e valid�-la, passando para 'funcaoPosFormatada'.
	...
	private boolean isOperator(String s)
	{
		...
		return (s.matches("[+\\-*/^~%()]|sin|cos|tan|asin|acos|atan|cot|sec|coss|log|ln|exp|sqrt"));
	}
